...
public class Z80Cpu {
	...
	public void exe(Memory mem) {
		// Pull opcode from memory and increment PC
		byte opcode = mem.get(this.pc++);
...
//		this.cycles += this.instructionCycles[opcode];
		...
		case 0x11:
			 ...
			 */
			this.setDE(read2Bytes(this.pc, mem));
			this.pc += 2;
			break;
		case 0x12:
			/*
		...
		case 0x21:
			 ...
			 */
			this.setHL(this.read2Bytes(this.pc, mem));
			this.pc += 2;
			break;
		case 0x22:
			/*
			 ...
			 */
			mem.set(this.read2Bytes(this.pc, mem),this.l);
			mem.set(this.read2Bytes((short)(this.pc+1), mem),this.h);
			this.pc += 2;
			break;
		case 0x23:
			/*
		...
		case 0x28:
			 ...
			 */
			if(this.flagZ) this.pc += mem.get(this.pc++);
			else this.pc++;
			break;
		case 0x29:
			/*
		...
		case 0x31:
			 ...
			 */
			this.sp = read2Bytes(this.pc, mem);
			this.pc += 2;
			break;
		case 0x32:
			/*
			 ...
			 */
			mem.set(read2Bytes(this.pc, mem),this.a);
			this.pc += 2;
			break;
		case 0x33:
			/*
		...
		case 0x34:
			 ...
			 */
			mem.set(this.getHL(),this.incr(mem.get(this.getHL())));
			break;
		case 0x35:
			/*
			 * DEC (HL)
			 ...
			 */
			mem.set(this.getHL(),this.decr(mem.get(this.getHL())));
			break;
		case 0x36:
			/*
			 * LD (HL), *
			 ...
			 */
			mem.set(this.getHL(),mem.get(this.pc++));
			break;
		case 0x37:
			/*
			 * SCF
		...
		case 0x38:
			 ...
			 * Otherwise continue
			 */
			if(this.flagC) this.pc += mem.get(this.pc++);
			else this.pc++;
			break;
		case 0x39:
			/*
		...
		case 0x3a:
			 ...
			 */
			this.a = mem.get(this.read2Bytes(this.pc, mem));
			this.pc += 2;
			break;
		case 0x3b:
			/*
	...
	private short read2Bytes(short counter, Memory mem) {
		short value;
		ByteBuffer bb = ByteBuffer.allocate(2);
		bb.order(ByteOrder.LITTLE_ENDIAN);
		bb.put(mem.get(counter));
		bb.put(mem.get((short)(counter+1)));
		value = bb.getShort(0);
		return value;
	}
	...
	private void jump(boolean flag, Memory mem) {
		this.pc = (short) (flag ? read2Bytes(this.pc, mem) : this.pc + 2);
	}
